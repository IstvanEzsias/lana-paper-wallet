...
export const translations: Record<Language, Translations> = {
  en: {
    ...
    results: {
      ...
      walletIdCompressedDesc: 'Address derived from compressed public key (Staking format WIF) — Preferred',
      walletIdUncompressed: 'Dominate Wallet ID',
      walletIdUncompressedDesc: 'Address derived from uncompressed public key (Dominate format WIF)',
      wifFormatCompressed: 'Staking WIF',
      wifFormatUncompressed: 'Dominate WIF',
  ...
  sl: {
    ...
    results: {
      ...
      walletIdCompressedDesc: 'Naslov izpeljan iz kompresiranega javnega ključa (Staking format WIF) — Priporočen',
      walletIdUncompressed: 'Dominate ID denarnice',
      walletIdUncompressedDesc: 'Naslov izpeljan iz nekompresiranega javnega ključa (Dominate format WIF)',
      wifFormatCompressed: 'Staking WIF',
      wifFormatUncompressed: 'Dominate WIF',
  ...
  hu: {
    ...
    results: {
      ...
      walletIdCompressedDesc: 'Cím a tömörített nyilvános kulcsból (Staking formátumú WIF) — Ajánlott',
      walletIdUncompressed: 'Dominate tárca azonosító',
      walletIdUncompressedDesc: 'Cím a tömörítetlen nyilvános kulcsból (Dominate formátumú WIF)',
      wifFormatCompressed: 'Staking WIF',
      wifFormatUncompressed: 'Dominate WIF',
